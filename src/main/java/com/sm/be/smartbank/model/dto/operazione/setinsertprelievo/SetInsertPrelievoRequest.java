package com.sm.be.smartbank.model.dto.operazione.setinsertprelievo;
...
@Setter
@Builder
public class SetInsertPrelievoRequest {
	...
	@Min(value = 20, message = "Per i prelievi l'importo minimo è 20 euro")
	private int importo;
